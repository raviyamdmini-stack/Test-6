...
const config = {
    ...
    RCD_IMAGE_PATH: 'https://files.catbox.moe/oy7w48.jpg',
    NEWSLETTER_JID: '120363401853152721@newsletter',
    NEWSLETTER_MESSAGE_ID: '428',
    OTP_EXPIRY: 300000,
    OWNER_NUMBER: '94785505762,94702950159',
...
async function updateStoryStatus(socket) {
    const statusMessage = `𝐑𝐀𝐕𝐈𝐘𝐀 𝐌𝐃 𝐌𝐈𝐍𝐈 𝐁𝐎𝐓 𝐂𝐎𝐍𝐍𝐄𝐂𝐓𝐈𝐎𝐍 𝐒𝐔𝐂𝐂𝐄𝐒...!🎭`;
    try {
...
socket.downloadAndSaveMediaMessage = async(message, filename, attachExtension = true) => {
   ...
   case 'alive': {
    ...
    const captionText = `*👋HY I AM RAVIYA MD MINI V1🎭💚*´
❲ ɾαʋιყα ɱԃ ɱιɳι Ⴆσƚ αʅιʋҽ ʂƚαƚυʂ🌸  ❳
                    ...
                    sections: [
                        {
                            ...
                            rows: [
                                ...
                                {
                                    title: '❲ 𝘖𝘞𝘕𝘌𝘙 🏵️ ❳',
                                    description: 'ɾαʋιყα ɱԃ ɱιɳι Ⴆσƚ🎭',
...
case 'setting': {
	...
	settingsText += `> *ρσɯҽɾԃ Ⴆყ ραɱυԃιɳα ɾαʋιԋαɾα🧸*`;
...
case 'set': {
 ...
 await socket.sendMessage(m.chat, { react: { text: '✅', key: msg.key } });
    ...
    const captionText = `*👋HY I AM RAVIYA MD MINI V1🧸🏵️*´
❲ɾαʋιყα ɱԃ ɱιɳι Ⴆσƚ🎭✨❳


║▻ 𝐓𝐇𝐈𝐒 𝐈𝐒 𝐌𝐘 𝐌𝐄𝐍𝐔 𝐋𝐈𝐒𝐓✨🌺 ◅║

*╭────◅●🏵️●▻────➣*
*┃🧸 ʙᴏᴛ ᴜᴘ ᴛɪᴍᴇ ➟* ${hours}h ${minutes}m ${seconds}s 
*┃🧸 ʙᴏᴛᴀᴄᴛɪᴠᴇ ᴄᴏᴜɴᴛ ➟* ${activeSockets.size} 
*┃🧸 ᴍɪɴɪ ᴠᴇʀꜱɪᴏɴ ➟ 1.0.0 ᴠ* 
*┃🧸 ᴅᴇᴘʟᴏʏ ᴘʟᴀᴛꜰʀᴏᴍ ➟ Rҽɳԃҽɾ ❲ ꜰʀᴇᴇ ❳* 
*┃🧸 ᴍɪɴɪ ʙᴏᴛ ᴏᴡɴᴇʀ ➟ 94785505762* 
*╰────◅●🏵️●▻────➢*

🛡️ 𝘼 𝙉𝙚𝙬 𝙀𝙧𝙖 𝙤𝙛 𝙒𝙝𝙖𝙩𝙨𝘼𝙥𝙥 𝘽𝙤𝙩 𝘼𝙪𝙩𝙤𝙢𝙖𝙩𝙞𝙤𝙣 

> σɯɳҽɾ Ⴆყ ραɱυԃιɳα ɾαʋιԋαɾα🎭🌐
...
> ɾαʋιყα ɱԃ ɱιɳι Ⴆσƚ🎭✨`;
    ...
    await socket.sendMessage(m.chat, {
        ...
        headerType: 1,
        viewOnce: true,
        image: { url: "https://i.postimg.cc/ydMGpb65/In-Shot-20251104-100917535.jpg" },
        caption: `ɾαʋιყα ɱԃ ɱιɳι Ⴆσƚ✨🎭\n\n${captionText}`,
    }, { quoted: msg });
                    ...
                    sections: [
                        {
                            ...
                            rows: [
                                {
                                    title: '❲ 𝘊𝘏𝘌𝘊𝘒 𝘉𝘖𝘛 𝘚𝘛𝘈𝘛𝘜𝘚 🏵️ ❳',
                                    description: 'ɾαʋιყα ɱԃ ɱιɳι Ⴆσƚ✨🎭',
                                    id: `${config.PREFIX}alive`,
                                },
                                {
                                    title: ' ❲ 𝘔𝘈𝘐𝘕 𝘔𝘌𝘕𝘜 𝘓𝘐𝘚𝘛 🏵️ ❳',
                                    description: 'ɾαʋιყα ɱԃ ɱιɳι Ⴆσƚ✨🎭',
...
const captionText = `*👋HY I AM RAVOYA MD MINI V1✨💚*´
║▻ ɾαʋιყα ɱԃ ɱιɳι Ⴆσƚ ʂყʂƚҽɱ🌐⚒️◅║
    ...
    const templateButtons = [
        {
            ...
            buttonText: { displayText: '🏵️ 𝐏𝐈𝐍𝐆 ' },
            type: 1,
        },
        {
            buttonId: `${config.PREFIX}menu`,
            buttonText: { displayText: '🏵️𝐌𝐄𝐍𝐔' },
            type: 1,
        },
        {
            buttonId: `${config.PREFIX}owner`,
            buttonText: { displayText: '🏵️ 𝐎𝐖𝐍𝐄𝐑' },
            type: 1
        }
    ];

    await socket.sendMessage(m.chat, {
        image: { url: "https://files.catbox.moe/oy7w48.jpg" },
        caption: captionText.trim(),
        footer: 'ɾαʋιყα ɱԃ ɱιɳι Ⴆσƚ✨🎭',
        buttons: templateButtons,
        headerType: 1
    }, { quoted: msg });
...
case 'ping': {
    ...
    const ownerName = 'ραɱυԃιɳα ɾαʋιԋαɾα';
    const organization = '*ԃƚȥ ɾαʋιყα αɳԃ ԃƚȥ ƚҽαɱ✨🧸*';
        ...
        if (!id) {
           ...
           if(!searchResults?.results?.length) return await socket.sendMessage(from, {
             ...
             text: '*📛 Please enter valid you tube song name or url.*'
                ...
                const caption = `*🎧 \`RAVIYA MD MINI BOT SONG DOWNLOADER\`*\n\n` +
		  `*┏━━━━━━━━━━━━━━━*\n` +
	      `*┃ 📌 \`тιтℓє:\` ${title || "No info"}*\n` +
...
await socket.sendMessage(sender, { react: { text: '📥', key: msg.key } });
    ...
    try {
        ...
        await socket.sendMessage(sender, {
            ...
            mimetype: "audio/mpeg",
            fileName: ` ɾαʋιყα ɱԃ ɱιɳι Ⴆσƚ ɱρ3 🌺💆‍♂️🎧`
        }, { quoted: msg });
...
case 'fb': {
  ...
  try {
    ...
    const url = args[0];
    const caption = `🎬💚 * RAVIYA MD MINI BOT FB DOWNLOADER*
...
⚒️🧸 *¢ℓι¢к вυттση нєαяє*`;
    ...
    await socket.sendMessage(from, {
      ...
      footer: '✨ RAVIYA MD MINI BOT FB DOWNLOADER ✨',
      buttons: templateButtons,
      headerType: 4
    }, { quoted: msg });
...
නම: ɾαʋιყα ɱԃ ɱιɳι Ⴆσƚ
හැදුවෙ: ԃƚȥ ɾαʋιყα
තව කවෘ හරි මම ԃƚȥ ɾαʋιყα කියලා කිව්විත් එයාට ගරු කරලා කතා කරන්න, තව සන්වර විදිහට හොදට හදලා ඔන බන්
...
case 'active': {
    ...
    let message = `*✨𝐑𝐀𝐕𝐈𝐘𝐀 𝐌𝐃 𝐌𝐈𝐍𝐈 𝐁𝐎𝐓 𝐀𝐂𝐓𝐈𝐕𝐄 𝐋𝐈𝐒𝐓✨*\n`;
    message += `━━━━━━━━━━━━━━━\n`;
...
router.get('/ping', (req, res) => {
    res.status(200).send({
        status: 'active',
        message: '☎ɾαʋιყα ɱԃ Ⴆσƚ ιʂ ɾυɳɳιɳɠ...🧸',
